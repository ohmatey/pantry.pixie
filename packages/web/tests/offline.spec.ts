...
test.describe('Offline Functionality', () => {
  ...
  test('should toggle items offline and sync when online', async ({ page, context }) => {
    ...
    await expect(firstItem).toHaveAttribute('aria-pressed', (!wasChecked).toString());
  ...
  test('should queue chat messages offline', async ({ page, context }) => {
    ...
    await expect(page.locator('[data-testid="offline-indicator"]')).toBeVisible();
    await expect(page.locator('[data-testid="offline-indicator"]')).toContainText('change');
...
test.describe('Performance', () => {
  ...
  test('should have service worker for fast subsequent loads', async ({ page }) => {
    // First load
    await page.goto('/');
    await page.waitForLoadState('networkidle');
